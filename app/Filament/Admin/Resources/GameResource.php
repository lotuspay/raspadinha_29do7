                ...
                ->schema([
                    ...
                    ->schema([
                        ...
                        ->schema([
                            ...
                            Forms\Components\Toggle::make('featured_section_1')
                                ->label('JOGADOS DA SEMANA')
                                ->default(false)
                                ->afterStateUpdated(function ($state, $record) {
                                    \Log::info('Estado do featured_section_1 atualizado:', [
                                        'game_id' => $record->id,
                                        'state' => $state
                                    ]);
                                }),
                            Forms\Components\Toggle::make('featured_section_2')
                                ->label('Mais Jogados'),
                            Forms\Components\Toggle::make('featured_section_3')
                                ->label('Roletas'),
                            Forms\Components\Toggle::make('featured_section_4')
                                ->label('Slots'),
                            Forms\Components\Toggle::make('featured_section_5')
                                ->label('MAIS PAGANTE HOJE'),

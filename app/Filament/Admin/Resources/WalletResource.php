                ...
                Forms\Components\Section::make()
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('balance_deposit_rollover')
                            ...
                            ->numeric()
                            ->default(0.00),
                        Forms\Components\TextInput::make('vip_level')
                            ->label('Vip Level')
                            ->numeric(),
                        Forms\Components\TextInput::make('vip_points')
                            ->label('Vip Pontos')
                            ->numeric(),
                          ])->columns(5),
                        ]);
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('balance')
                    ...
                    ->sortable(),
                Tables\Columns\TextColumn::make('balance_deposit_rollover')
                    ->label('Rollover')
                    ->badge()
                    ->color('info')
                    ->formatStateUsing(fn (string $state): string => \Helper::amountFormatDecimal($state))

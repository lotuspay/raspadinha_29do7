                ...
                Filter::make('commission_type')
                    ...
                    ->query(function (Builder $query, array $data): Builder {
                        return $query
                            ->when(
                                ...
                                fn (Builder $query, $commission_type): Builder => $query->where('commission_type', $commission_type),
                            );
                    })
                    ->indicateUsing(function (array $data): array {
                        ...
                        if ($data['commission_type'] ?? null) {
                            $indicators['commission_type'] = 'Tipo: ' . ($data['commission_type'] === 'cpa' ? 'CPA' : 'RevShare');
                        }

...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="dark">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="192x192" href="<?php echo e(asset('/storage/uploads/pbP7W9bKZmZBKOJjH57iaqG538RiKUzTBjueUzVe.png')); ?>">
      
      <!-- Meta Tags Essenciais -->
        <title><?php echo e(env('APP_NAME')); ?> - A raspadinha número 1 do Brasil</title>
        <meta name="description" content="Jogue na <?php echo e(env('APP_NAME')); ?> e descubra o melhor cassino online ao vivo! Aposte em esportes e cassino com bônus exclusivos. Depósitos rápidos via Pix.">

        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="website">
        <meta property="og:title" content="<?php echo e(env('APP_NAME')); ?> - A raspadinha número 1 do Brasil">
        <meta property="og:description" content="Raspe na <?php echo e(env('APP_NAME')); ?>! A raspadinha número 1 do Brasil. Depósitos via Pix e saques instantâneos.">
        <meta property="og:image" content="<?php echo e(asset('/storage/uploads/pbP7W9bKZmZBKOJjH57iaqG538RiKUzTBjueUzVe.png')); ?>">
        <meta property="og:url" content="<?php echo e(url('/')); ?>">
        <meta property="og:site_name" content="<?php echo e(env('APP_NAME')); ?>">

        <!-- Twitter -->
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="<?php echo e(env('APP_NAME')); ?> - A raspadinha número 1 do Brasil">
        <meta name="twitter:description" content="Entre no mundo das apostas com <?php echo e(env('APP_NAME')); ?>! Cassino ao vivo, jogos exclusivos e bônus especiais para novos jogadores.">
        <meta name="twitter:image" content="<?php echo e(asset('/storage/uploads/pbP7W9bKZmZBKOJjH57iaqG538RiKUzTBjueUzVe.png')); ?>">

        <!-- SEO Keywords -->
        <meta name="keywords" content="Cassino online, apostas esportivas, jogos de azar, slots, roleta, blackjack, poker, cassino ao vivo, bônus cassino, <?php echo e(env('APP_NAME')); ?>, apostas com Pix">

...
<?php $component->withAttributes([]); ?>
 ...
 <div class="w-full p-4 bg-gray-500 shadow-lg" style="background-color: #51515163; border-radius: 20px; border: 5px solid; animation: border-color-animation 4s infinite;">
        <h2 class="mb-5 text-3xl">Drakon API </h2>
        <p>Velocidade e Estabilidade inagualável! Compre direto pelo site: <a href="https://gator.drakon.casino" target="_blank" style="color: red;">gator.drakon.casino</a> Telegram: <a href="https://t.me/drakongator" target="_blank" style="color: red;">@drakonsuporte</a></p>
        <br>
        <div class="flex justify-between w-full gap-4">
            <div class="flex flex-col gap-4 w-full justify-between">
                <button wire:click="loadProviderDrakon" style="border-radius: 10px" class="bg-primary-600 px-3 py-2 w-full text-center">
                    <div wire:loading wire:target="loadProviderDrakon">Carregando Provedores</div>
                    <div wire:loading.remove wire:target="loadProviderDrakon">Carregar Provedores</div>
                </button>

            </div>
            <button wire:click="loadGamesDrakon" style="border-radius: 10px; overflow: hidden; position: relative; background-color: #7f3cb9" class="bg-primary-500 px-3 py-2 w-full">
                <div class="flex flex-col gap-4 w-full justify-between">
                    <div wire:loading wire:target="loadGamesDrakon">
                    ...
                    <div wire:loading.remove wire:target="loadGamesDrakon">
                        Carregar Jogos
                    </div>
                </div>
            </button>
...
<?php endif; ?>
<?php /**PATH D:\WindSurfProjects\raspadinha_29do7\resources\views\filament\pages\advanced-page.blade.php ENDPATH**/ ?>
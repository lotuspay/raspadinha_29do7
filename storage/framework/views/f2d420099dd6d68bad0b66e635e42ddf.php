...
<div>
    <?php if($sidebar->getPageNavigationLayout() == \AymanAlhattami\FilamentPageWithSidebar\Enums\PageNavigationLayoutEnum::Sidebar): ?>
        <div class="mt-8">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-page-with-sidebar::components.topbar.index','data' => ['sidebar' => $sidebar]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH D:\WindSurfProjects\raspadinha_29do7\vendor\aymanalhattami\filament-page-with-sidebar\resources\views\components\page.blade.php ENDPATH**/ ?>